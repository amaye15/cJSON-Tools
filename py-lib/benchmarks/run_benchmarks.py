...
def run_comprehensive_benchmark(args):
    ...
    try:
        result = subprocess.run(cmd, cwd=os.path.dirname(os.path.dirname(__file__)), check=True)
...
Examples:
  ...
  %(prog)s --comprehensive --size medium # Test medium dataset only
    ...
    parser.add_argument("--original", action="store_true",
                       help="Run original benchmark with plotting")
    ...
    parser.add_argument("--plot", type=str,
                       help="Directory to save plots (original benchmark)")
    parser.add_argument("--json-output", type=str,
                       help="JSON file to save results (original benchmark)")

    ...
    def _execute_operations_fallback(self) -> str:
        ...
        for op in self._operations:
            if op['type'] == 'remove_empty_strings':
                ...
                result = _cjson_tools.replace_keys(result, op['pattern'], op['replacement'], self._pretty_print)
            elif op['type'] == 'replace_values':
                result = _cjson_tools.replace_values(result, op['pattern'], op['replacement'], self._pretty_print)

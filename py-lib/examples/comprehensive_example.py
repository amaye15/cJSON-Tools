...
def demo_performance_comparison():
    ...
    def run_multi_pass(data):
        ...
        result = replace_keys(result, r'^session\.tracking\..*\.timeMs$', 'session.pageTimesInMs.UnifiedPage')
        result = replace_keys(result, r'^analytics\.page\..*\.visits$', 'analytics.pageViews.TotalPage')
